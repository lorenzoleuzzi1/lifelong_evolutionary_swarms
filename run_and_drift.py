...
if __name__ == "__main__":
    ...
    parser.add_argument('--eval_retention', type=str, default="top", help='The evaluation retention strategy.')
    ...
    if args.regularization is not None and args.regularization not in ["gd", "wp", "genetic_distance", "weight_protection"]:
    ...
    if args.eval_retention not in ["top", "population"]:
        raise ValueError("Evaluation retention must be one of: top or population")
