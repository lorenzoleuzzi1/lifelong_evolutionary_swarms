...
for param in "${param_space[@]}"; do
    ...
    srun --nodes=1 --ntasks=1 -w ${nodes_array[1]} python3.11 run_and_drift.py --name reg_g_$reg/$paramstr --evo neat --steps 500 --generations 100 --population 100 --agents 5 --blocks 20 --colors 4 --seed ${seeds[1]} --distribution $distribution --regularization $reg --lambdas $param  --targets 3 4 3 --eval_retention top --n_env 10 --workers 64 &
    srun --nodes=1 --ntasks=1 -w ${nodes_array[1]} python3.11 run_and_drift.py --name reg_g_$reg/$paramstr --evo neat --steps 500 --generations 100 --population 100 --agents 5 --blocks 20 --colors 4 --seed ${seeds[1]} --distribution $distribution --regularization $reg --lambdas $param  --targets 3 4 3 --eval_retention top --n_env 10 --workers 64 &
    srun --nodes=1 --ntasks=1 -w ${nodes_array[2]} python3.11 run_and_drift.py --name reg_g$reg/$paramstr --evo neat --steps 500 --generations 100 --population 100 --agents 5 --blocks 20 --colors 4 --seed ${seeds[2]} --distribution $distribution --regularization $reg --lambdas $param  --targets 3 4 3 --eval_retention top --n_env 10 --workers 64 &
